...
parser.add_argument('--dataset_name', dest='dataset_name', default='wheat', help='name of the dataset')
...
parser.add_argument('--input_nc', dest='input_nc', type=int, default=11, help='# of input image channels')  #input picture numbers
...
parser.add_argument('--hyper_dim', dest='hyper_dim', type=int, default=170, help='')   #hyperspectal dim
...
def main(_):
    ...
    with tf.Session() as sess:
        model = pix2pix(sess, image_size=args.fine_size, batch_size=args.batch_size,
                        ...
                        gf_dim=args.ngf, df_dim=args.ndf,
                        input_c_dim=args.input_nc, output_c_dim=args.output_nc, hyper_dim=args.hyper_dim
                        )
